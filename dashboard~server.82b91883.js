(window.webpackJsonp = window.webpackJsonp || []).push([[6], {
    330: function(e, t, r) {
        "use strict";
        var c, a = "object" == typeof Reflect ? Reflect : null, n = a && "function" == typeof a.apply ? a.apply : function(e, t, r) {
            return Function.prototype.apply.call(e, t, r)
        }
        ;
        c = a && "function" == typeof a.ownKeys ? a.ownKeys : Object.getOwnPropertySymbols ? function(e) {
        ...
        function f(e, t, r, c) {
            ...
            if (void 0 === (n = e._events) ? (n = e._events = Object.create(null),
            e._eventsCount = 0) : (void 0 !== n.newListener && (e.emit("newListener", t, r.listener ? r.listener : r),
            n = e._events),
            i = n[t]),
            void 0 === i)
                i = n[t] = r,
                ++e._eventsCount;
            else if ("function" == typeof i ? i = n[t] = c ? [r, i] : [i, r] : c ? i.unshift(r) : i.push(r),
            (a = o(e)) > 0 && i.length > a && !i.warned) {
                i.warned = !0;
        ...
        s.prototype.removeListener = function(e, t) {
            ...
            if (void 0 === (r = c[e]))
                return this;
            if (r === t || r.listener === t)
                0 == --this._eventsCount ? this._events = Object.create(null) : (delete c[e],
                c.removeListener && this.emit("removeListener", e, r.listener || t));
                ...
                1 === r.length && (c[e] = r[0]),
                void 0 !== c.removeListener && this.emit("removeListener", e, i || t)
            }
            return this
        }
        ,
        ...
        s.prototype.removeAllListeners = function(e) {
            ...
            if (0 === arguments.length) {
                ...
                for (c = 0; c < n.length; ++c)
                    "removeListener" !== (a = n[c]) && this.removeAllListeners(a);
    ...
    410: function(e, t, r) {
        ...
        var f = () => {
            const e = i.a.useStoreState((e => e.server.data.uuid))
              , t = i.a.useStoreActions((e => e.server.getServer))
              , r = i.a.useStoreActions((e => e.server.setServerFromState));
            return Object(n.a)(s.a.TRANSFER_STATUS, (c => {
                "pending" !== c && "processing" !== c ? "failed" !== c ? "completed" === c && t(e).catch((e => console.error(e))) : r((e => o(o({}, e), {}, {
                    isTransferring: !1
                }))) : r((e => o(o({}, e), {}, {
                    isTransferring: !0
                })))
        ...
        function v() {}
        var g = function(e, t) {
            var r, c = 0, a = 1, n = {}, i = (t = t || {}).maxAttempts || 1 / 0;
            return n.open = function() {
                (r = new WebSocket(e,t.protocols || [])).onmessage = t.onmessage || v,
                r.onopen = function(e) {
                    (t.onopen || v)(e),
                    c = 0
                }
                ...
                r.onclose = function(e) {
                    1e3 === e.code || 1001 === e.code || 1005 === e.code || n.reconnect(e),
                    (t.onclose || v)(e)
                }
                ,
                r.onerror = function(e) {
                    e && "ECONNREFUSED" === e.code ? n.reconnect(e) : (t.onerror || v)(e)
                }
            }
            ,
            n.reconnect = function(e) {
                a && c++ < i ? a = setTimeout((function() {
                    (t.onreconnect || v)(e),
                    n.open()
                }
                ), t.timeout || 1e3) : (t.onmaximum || v)(e)
            }
            ,
            n.json = function(e) {
          ...
          , b = r(330);
        class x extends b.EventEmitter {
            constructor() {
                super(...arguments),
                a()(this, "timer", null),
                a()(this, "backoff", 5e3),
            ...
            connect(e) {
                return this.url = e,
                this.socket = new g("".concat(this.url),{
                    onmessage: e => {
                        try {
                            const {event: t, args: r} = JSON.parse(e.data);
                            r ? this.emit(t, ...r) : this.emit(t)
                        } catch (e) {
                    ...
                    onerror: e => this.emit("SOCKET_ERROR", e)
                }),
                this.timer = setTimeout(( () => {
                    this.backoff = this.backoff + 2500 >= 2e4 ? 2e4 : this.backoff + 2500,
            ...
            authenticate() {
                this.url && this.token && this.send("auth", this.token)
            }
            close(e, t) {
                this.url = null,
                this.token = "",
                this.socket && this.socket.close(e, t)
            }
            open() {
            ...
            send(e, t) {
                this.socket && this.socket.send(JSON.stringify({
                    event: e,
                    args: Array.isArray(t) ? t : [t]
                }))
            }
        }
        var w = r(17)
          , O = e => new Promise(( (t, r) => {
            w.a.get("/api/client/servers/".concat(e, "/websocket")).then((e => {
                let {data: r} = e;
                return t({
                    token: r.data.token,
                    socket: r.data.socket
                })
            }
            )).catch(r)
        }
          ...
          , E = r(35)
          , k = r(24);
        const M = ["jwt: exp claim is invalid", "jwt: created too far in past (denylist)"];
        var A = () => {
            let e = !1;
            const [t,r] = Object(p.useState)("")
              , {connected: c, instance: a} = i.a.useStoreState((e => e.socket))
              , n = i.a.useStoreState((e => {
                var t;
                return null === (t = e.server.data) || void 0 === t ? void 0 : t.uuid
            }
            ))
              , s = i.a.useStoreActions((e => e.status.setServerStatus))
              , {setInstance: l, setConnectionState: o} = i.a.useStoreActions((e => e.socket))
              , f = (t, r) => {
                e || (e = !0,
                O(t).then((e => r.setToken(e.token, !0))).catch((e => console.error(e))).then(( () => {
                    e = !1
                }
                )))
            }
              , d = e => {
                const t = new x;
                t.on("auth success", ( () => o(!0))),
                t.on("SOCKET_CLOSE", ( () => o(!1))),
                t.on("SOCKET_ERROR", ( () => {
                    r("connecting"),
                    o(!1)
                }
                ...
                t.on("status", (e => s(e))),
                t.on("daemon error", (e => {
                    console.warn("Got error message from daemon socket:", e)
                }
                )),
                t.on("token expiring", ( () => f(e, t))),
                t.on("token expired", ( () => f(e, t))),
                t.on("jwt error", (c => {
                    o(!1),
                    console.warn("JWT validation error from wings:", c),
                    M.find((e => c.toLowerCase().indexOf(e) >= 0)) ? f(e, t) : r("There was an error validating the credentials provided for the websocket. Please refresh the page.")
                }
                )),
                t.on("transfer status", (c => {
                    "starting" !== c && "success" !== c && (t.close(),
                    r("connecting"),
                    o(!1),
                    l(null),
                    d(e))
                ...
                O(e).then((e => {
                    t.setToken(e.token).connect(e.socket),
                    l(t)
                }
            ...
            t ? h.a.createElement(E.a, {
                timeout: 150,
                in: !0,
                appear: !0,
                classNames: "fade"
            }, h.a.createElement(Z, null, h.a.createElement(j, null, "connecting" === t ? h.a.createElement(h.a.Fragment, null, h.a.createElement(k.a, {
                size: "small"
            }), h.a.createElement(_, null, "We're having some trouble connecting to your server, please wait...")) : h.a.createElement(C, null, t)))) : null
        }
          , Z = Object(y.c)("div").withConfig({
        ...
        var I = () => {
            const e = i.a.useStoreState((e => e.server.data.uuid))
              , t = i.a.useStoreActions((e => e.server.getServer))
              , r = i.a.useStoreActions((e => e.server.setServerFromState));
            return Object(n.a)(s.a.BACKUP_RESTORE_COMPLETED, ( () => {
                Object(R.b)(Object(q.b)(e, "/"), void 0),
                r((e => D(D({}, e), {}, {
                    status: null
                })))
            }
            )),
            Object(n.a)(s.a.INSTALL_COMPLETED, ( () => {
                t(e).catch((e => console.error(e)))
            }
            )),
            Object(n.a)(s.a.INSTALL_STARTED, ( () => {
                r((e => D(D({}, e), {}, {
                    status: "installing"
                })))
            }
          ...
          , G = r.n(Y)
          , Q = () => {
            const e = i.a.useStoreState((e => {
                var t;
                return (null === (t = e.server.data) || void 0 === t ? void 0 : t.status) || null
            }
            ))
              , t = i.a.useStoreState((e => {
                var t;
                return (null === (t = e.server.data) || void 0 === t ? void 0 : t.isTransferring) || !1
            }
            ))
              , r = i.a.useStoreState((e => {
                var t;
                return (null === (t = e.server.data) || void 0 === t ? void 0 : t.isNodeUnderMaintenance) || !1
            }
            ));
            return "installing" === e || "install_failed" === e || "reinstall_failed" === e ? h.a.createElement(T.c, {
                title: "Running Installer",
                image: B.a,
                message: "Your server should be ready soon, please try again in a few minutes."
            }) : "suspended" === e ? h.a.createElement(T.c, {
                title: "Server Suspended",
                image: V.a,
                message: "This server is suspended and cannot be accessed."
            }) : r ? h.a.createElement(T.c, {
                title: "Node under Maintenance",
                image: V.a,
                message: "The node of this server is currently under maintenance."
            }) : h.a.createElement(T.c, {
                title: t ? "Transferring" : "Restoring from Backup",
                image: G.a,
                message: t ? "Your server is being transferred to a new node, please check back later." : "Your server is currently being restored from a backup, please check back in a few minutes."
            })
        }
          , $ = r(7)
          , X = r.n($)
          , ee = e => {
            let {permission: t, children: r} = e
              , c = X()(e, ["permission", "children"]);
            return h.a.createElement(d.c, c, t ? h.a.createElement(L.a, {
                matchAny: !0,
                action: t,
                renderOnError: h.a.createElement(T.b, {
                    title: "Access Denied",
        ...
        t.default = () => {
            const e = Object(d.i)()
              , t = Object(U.h)()
              , r = Object(P.useStoreState)((e => e.user.data.rootAdmin))
              , [c,a] = Object(p.useState)("")
              , n = i.a.useStoreState((e => {
                var t;
                return null === (t = e.server.data) || void 0 === t ? void 0 : t.id
            }
            ))
              , s = i.a.useStoreState((e => {
                var t;
                return null === (t = e.server.data) || void 0 === t ? void 0 : t.uuid
            }
            ))
              , l = i.a.useStoreState((e => e.server.inConflictState))
              , o = i.a.useStoreState((e => {
                var t;
                return null === (t = e.server.data) || void 0 === t ? void 0 : t.internalId
            }
            ))
              , y = i.a.useStoreActions((e => e.server.getServer))
              , v = i.a.useStoreActions((e => e.clearServerState))
              , g = function(t) {
                let r = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                return "/" === t ? r ? e.url : e.path : "".concat((r ? e.url : e.path).replace(/\/*$/, ""), "/").concat(t.replace(/^\/+/, ""))
            };
            return Object(p.useEffect)(( () => () => {
                v()
            }
            ), []),
            Object(p.useEffect)(( () => (a(""),
            y(e.params.id).catch((e => {
                console.error(e),
                a(Object(w.c)(e))
            }
            )),
            ...
            h.a.createElement(h.a.Fragment, {
                key: "server-router"
            }, h.a.createElement(u.a, null), s && n ? h.a.createElement(h.a.Fragment, null, h.a.createElement(E.a, {
                timeout: 150,
                classNames: "fade",
                appear: !0,
                in: !0
            }, h.a.createElement(N.a, null, h.a.createElement("div", null, te.a.server.filter((e => !!e.name)).map((e => e.permission ? h.a.createElement(L.a, {
                key: e.path,
                action: e.permission,
                matchAny: !0
            }, h.a.createElement(d.b, {
                to: g(e.path, !0),
                exact: e.exact
            }, e.name)) : h.a.createElement(d.b, {
                key: e.path,
                to: g(e.path, !0),
                exact: e.exact
            }, e.name))), r && h.a.createElement("a", {
                href: "/admin/servers/view/".concat(o),
                target: "_blank"
            }, h.a.createElement(K.a, {
                icon: W.r
            }))))), h.a.createElement(I, null), h.a.createElement(f, null), h.a.createElement(A, null), l && (!r || r && !t.pathname.endsWith("/server/".concat(n))) ? h.a.createElement(Q, null) : h.a.createElement(H.a, null, h.a.createElement(m.a, null, h.a.createElement(d.e, {
                location: t
            }, te.a.server.map((e => {
                let {path: t, permission: r, component: c} = e;
                return h.a.createElement(ee, {
                    key: t,
                    permission: r,
                    path: g(t),
                    exact: !0
                }, h.a.createElement(k.a.Suspense, null, h.a.createElement(c, null)))
            }
            )), h.a.createElement(d.c, {
                path: "*",
                component: T.a
            }))))) : c ? h.a.createElement(T.b, {
                message: c
            }) : h.a.createElement(k.a, {
                size: "large",
                centered: !0
